<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        if(isset($_POST['delete-item'])){
            $delete = $cart->deleteItem($_POST['item_id'],'product');
        } elseif(isset($_POST['delete-user'])){
            $delete = $cart->deleteUser($_POST['_user_id'],'users');
        } elseif(isset($_POST['delete-cart'])){
            $delete = $cart->deleteCart($_POST['cart_id'],'cart');
        ...
        <div id="myBtnContainer">
                ...
                <tr>
					...
					<td>
						<form method="post">
							...
							<button type="submit" name="delete-item">Remove</button>
						</form>
					</td>
                </tr>
                <?php }?>
            ...
            <table class="users admin-table">
                ...
                <tr>
                    ...
                    <td>
						<form method="post">
							<input type="hidden" value="<?php echo $item['_user_id'] ?>" name="_user_id">
